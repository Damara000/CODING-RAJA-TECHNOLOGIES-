...
class ToDoApp(tk.Tk):
    ...
    def create_widgets(self):
        self.task_listbox = tk.Listbox(self, width=80, height=15, font=("boulder", 12), selectbackground="aqua", selectmode=tk.SINGLE)
        self.task_listbox.pack(pady=10, padx=10)

        self.refresh_tasks()

        add_button = tk.Button(self, text="Add Task", command=self.add_task, font=("boulder", 12), bg="yellow", fg="black")
        add_button.pack(pady=5)

        remove_button = tk.Button(self, text="Remove Task", command=self.remove_task, font=("boulder", 12), bg="pink", fg="black")
        remove_button.pack(pady=5)

        complete_button = tk.Button(self, text="Mark as Completed", command=self.mark_completed, font=("boulder", 12), bg="darkgreen", fg="black")
